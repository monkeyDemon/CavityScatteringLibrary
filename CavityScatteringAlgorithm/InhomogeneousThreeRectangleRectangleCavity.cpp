...
InhomogeneousThreeRectangleRectangleCavity::InhomogeneousThreeRectangleRectangleCavity(unsigned int cavityType) :InhomogeneousThreeRectangleCavity(cavityType)
{
	int test = 0;
}

void InhomogeneousThreeRectangleRectangleCavity::InitCavityInhomogeneousShapeParameter(cavityBox box1, cavityBox box2, cavityBox box3)
{
...
double InhomogeneousThreeRectangleRectangleCavity::phi_int(double x, double y)
{
	double x_left;
	double x_right;
	double y_bottom;
