...
InhomogeneousThreeRectangleCircleCavity::InhomogeneousThreeRectangleCircleCavity(unsigned int cavityType) :InhomogeneousThreeRectangleCavity(cavityType)
{
	int test = 0;
}

void InhomogeneousThreeRectangleCircleCavity::InitCavityInhomogeneousShapeParameter(cavityCircle circle1, cavityCircle circle2, cavityCircle circle3)
{
...
double InhomogeneousThreeRectangleCircleCavity::phi_int(double x, double y)
{
