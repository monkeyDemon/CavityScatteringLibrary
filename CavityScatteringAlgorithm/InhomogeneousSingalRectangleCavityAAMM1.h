...
class  _declspec(dllexport) InhomogeneousSingalRectangleCavityAAMM1 : public InhomogeneousSingalRectangleCavity
{
public:
	InhomogeneousSingalRectangleCavityAAMM1(unsigned int cavityType);
